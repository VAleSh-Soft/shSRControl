...
### История версий
 Версия 1.3 - 
* теперь вывод отладочных сообщений возможен в любой поток, наследующий класс **Print**, будь то **Serial**, **File**, и т.д.;
...
+ добавлены методы `addRelay()`, позволяющие добавить данные локального или удаленного реле;
