...
- для модуля выключателя - кнопки и описания удаленных реле, привязанных к кнопкам; кнопки позволяют переключать состояние удаленных реле кликом мыши;
